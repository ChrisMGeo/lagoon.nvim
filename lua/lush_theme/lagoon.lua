...
local theme = lush(function(injected_functions)
	...
	return {
		...
		Normal({ fg = palette.quillGrey, bg = palette.black1 }), -- Normal text
		...
		NeoTreeNormal({ Normal, fg = palette.ash }),
		...
		SignColumn({ bg = palette.black1 }), -- Column where |signs| are displayed
		...
		Search({ fg = palette.mikado }), -- Last search pattern highlighting (see 'hlsearch'). Also used for similar items that need to stand out.
		...
		sym("@string.regex")({ fg = palette.redDamask }),
		...
		sym("@operator.html")({ Special }),
		-- sym"@keyword"           { }, -- Keyword
		-- sym"@exception"         { }, -- Exception
		-- sym"@variable"          { }, -- Identifier
		-- sym"@type"              { }, -- Type
		-- sym"@type.definition"   { }, -- Typedef
		sym("@type.qualifier")({ fg = palette.contessa }),
		...
		-- sym"@tag"               { }, -- Tag
		sym("@tag.tsx")({ Tag }),
		sym("@tag.delimiter")({ Special }),
		sym("@tag.attribute")({ fg = palette.fallow }),
		sym("@attribute.java")({ fg = palette.contessa }),
